        ...
        <nav class="app-header navbar navbar-expand bg-body">
            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item d-none d-md-block"><a href="<?php echo base_url('admin'); ?>"
                            class="nav-link">홈</a></li>
                    <li class="nav-item d-none d-md-block"><a href="<?php echo base_url('logout'); ?>"
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            ...
                            <li class="user-footer">
                                ...
                                <a href="<?php echo base_url('logout'); ?>"
                                    class="btn btn-default btn-flat float-end">로그아웃</a>
                            </li>
                            <!--end::Menu Footer-->
                        </ul>
                    </li>
