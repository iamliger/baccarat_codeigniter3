      		...
      		<nav class="mt-2">
      			...
      			<ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="navigation"
      				...
      				<li class="nav-item">
      					...
      					<ul class="nav nav-treeview">
      						...
      						<li class="nav-item"><a href="<?php echo base_url('admin/game/ai_logic_management'); ?>"
      								class="nav-link"><i class="nav-icon bi bi-cpu"></i>
      								<p>AI로직관리</p>
      							</a></li>
      					</ul>
      				</li>
      				...
      				<li class="nav-item menu-open">
      					<!-- 이 메뉴는 현재 구현할 것이므로 menu-open 클래스를 부여 -->
      					...
      					<ul class="nav nav-treeview">
      						<li class="nav-item">
      							...
      							<ul class="nav nav-treeview">
      								<li class="nav-item"><a href="<?php echo base_url('admin/members/all'); ?>" class="nav-link"><i
      											class="nav-icon bi bi-dot"></i>
      										<p>전체 회원</p>
      									</a></li>
      								<li class="nav-item"><a href="<?php echo base_url('admin/members/new'); ?>" class="nav-link"><i
      											class="nav-icon bi bi-dot"></i>
      										<p>신규 가입</p>
      									</a></li>
      								<li class="nav-item"><a href="<?php echo base_url('admin/members/pending_verification'); ?>"
      										class="nav-link"><i class="nav-icon bi bi-dot"></i>
      										<p>인증 대기</p>
      									</a></li>
      						...
      						<li class="nav-item">
      							...
      							<ul class="nav nav-treeview">
      								...
      								<li class="nav-item"><a
      										href="<?php echo base_url('admin/member/verification/sanction_history'); ?>"
      										class="nav-link"><i class="nav-icon bi bi-dot"></i>
      										<p>제재/해제 이력</p>
      									</a></li>
      							</ul>
      						...
      						<li class="nav-item">
      							<a href="<?php echo base_url('admin/member/withdrawal_management'); ?>" class="nav-link">
      				...
      				<li class="nav-item">
      					...
      					<ul class="nav nav-treeview">
      						<li class="nav-item"><a href="<?php echo base_url('admin/permissions/admin_accounts'); ?>"
      								class="nav-link"><i class="nav-icon bi bi-person-fill-gear"></i>
      								<p>관리자 계정</p>
      							</a></li>
      						<li class="nav-item"><a href="<?php echo base_url('admin/permissions/role_definitions'); ?>"
      								class="nav-link"><i class="nav-icon bi bi-people-fill"></i>
      								<p>역할(Role) 정의</p>
      							</a></li>
      						<li class="nav-item"><a href="<?php echo base_url('admin/permissions/access_control'); ?>"
      								class="nav-link"><i class="nav-icon bi bi-shield-check"></i>
      								<p>접근 권한</p>
      							</a></li>
      					</ul>
      				</li>
      				...
      				<li class="nav-item">
      					...
      					<ul class="nav nav-treeview">
      						<li class="nav-item"><a href="<?php echo base_url('admin/content/notices'); ?>" class="nav-link"><i
      									class="nav-icon bi bi-megaphone"></i>
      								<p>공지사항</p>
      							</a></li>
      						<li class="nav-item"><a href="<?php echo base_url('admin/content/banners'); ?>" class="nav-link"><i
      									class="nav-icon bi bi-easel"></i>
      								<p>배너/팝업</p>
      							</a></li>
      						<li class="nav-item"><a href="<?php echo base_url('admin/content/faq'); ?>" class="nav-link"><i
      				...
      				<li class="nav-item">
      					...
      					<ul class="nav nav-treeview">
      						<li class="nav-item"><a href="<?php echo base_url('admin/logs/system'); ?>" class="nav-link"><i
      									class="nav-icon bi bi-file-earmark-text"></i>
      								<p>시스템 로그</p>
      							</a></li>
      						<li class="nav-item"><a href="<?php echo base_url('admin/logs/security'); ?>" class="nav-link"><i
      									class="nav-icon bi bi-shield-lock"></i>
      								<p>보안 로그</p>
      							</a></li>
      						<li class="nav-item"><a href="<?php echo base_url('admin/logs/admin_activity'); ?>"
      								class="nav-link"><i class="nav-icon bi bi-person-workspace"></i>
      								<p>관리자 활동 이력</p>
      							</a></li>
      					</ul>
      				</li>
